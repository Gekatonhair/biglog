        ...
        <Col xs={12} sm={12} md={12} lg={5}>
            ...
            <ul>
                ...
                <li>
                    ...
                    благодаря обжигу наружной поверхности дерева, происходит закупорка каналов волокон смолами и продуктами горения;
                </li>
                <li>
                ...
                <li>
                    ...
                    растрескивания при переходе температур через 0°C.
                </li>
            </ul>
            <br />
            <h3>Цены:</h3>
            <ul>
                <li>
                    Стоимость 1м² забора составляет 4 тыс. руб. для "плетеного" и "классического" забора и 4.8 тыс. руб. для "ёлочки" и
                    "шахматки";
                </li>
                <li>
                ...
                <li>В подарок всегда идёт воск для послегарантийного обслуживания минимум на 5 лет.</li>
            </ul>
        </Col>
